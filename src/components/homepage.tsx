    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            <header className="bg-purple-800 text-white text-center py-20">
                ...
                <p className="text-lg">
                    Helping lecturers provide better and faster feedback to
                    their students.
                </p>
            </header>
                    ...
                    <div className="flex justify-center space-x-10">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                            ...
                            <p className="text-black">
                                Lecturers can provide instant feedback to
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                            ...
                            <p className="text-black">
                                Analyze student performance and give tailored
                                advice.
                            </p>
                        </div>
                    </div>
                ...
                <section id="about" className="py-20 text-center">
                    ...
                    <div className="bg-purple-100 p-8 rounded-lg shadow-lg max-w-4xl mx-auto">
                        <p className="text-lg text-black">
                            We are a group of passionate students working on a
                            development project aimed at making education more
                            efficient. Our platform provides tools that allow
                            lecturers to give real-time feedback and valuable
                            insights to students, improving the overall learning
                            experience.
                        </p>
                    </div>
                    ...
                    <div className="mt-12 bg-purple-100 p-8 rounded-lg shadow-lg max-w-4xl mx-auto">
                        ...
                        <p className="text-lg text-black">
                            Our mission is to create a user-friendly system that
                            helps bridge the gap between lecturers and students,
                            providing faster, more effective feedback and
